...
export const Header = ({ setItemSearch }: TypeItemSearch) => {
        ...
        <header className='bg-white'>
            <div className="flex items-center justify-evenly p-4 border-b">
                ...
                <div className="flex items-center">
                    <PrimaryInput setItemSearch={setItemSearch}/>
                    <div className="ml-3 relative">
                        ...
                        <span className="absolute top-0 right-0 -mt-2 -mr-2 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full">{cartItems.length}</span>
                    </div>
                </div>
            </div>
        </header>
